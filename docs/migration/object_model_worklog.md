...
## 2026-01-19T23:07:53+0900
Summary:
- 面のローカル基準軸を構造の面名から決定し、Right/Bottom の向きズレを解消する土台を追加
- Net の 2D 変換も同一基準軸で統一

Notes:
- 面の向きはヒンジ選定ではなく基準軸の整合で解決する

## 2026-01-19T22:35:39+0900
Summary:
- 構造情報から faceId→ラベルを導出し、手動の面名マッピングを廃止
- Net のレイアウトも構造の faceId を参照して構築するよう整理
