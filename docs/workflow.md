...
あなたが提案した作業、作業ステップ（作業Phaseなど）がユーザーに承認された場合には、該当する Issue にタスクとして追加してから作業を進めます。
調査タスクを実行した場合には、その調査結果を Issue に追加します
ひとつのタスクが終わるごとに作業ブランチに対して **コミット** をし、作業上の留意点や気づきがあればその内容を詳しく Issue に記載します。
